...
const menuPanelClass = cn(
  ...
  "[&_button]:flex [&_button]:h-[30px] [&_button]:w-full [&_button]:cursor-pointer [&_button]:items-center [&_button]:gap-2 [&_button]:rounded-[5px] [&_button]:border-0 [&_button]:bg-transparent [&_button]:px-[9px] [&_button]:text-left [&_button]:text-[11px] [&_button]:text-text",
  "[&_button:hover]:bg-panel-soft [&_button:hover]:text-white",
  "[&_button:disabled]:cursor-default [&_button:disabled]:opacity-40 [&_button:disabled:hover]:bg-transparent [&_button:disabled:hover]:text-text",
