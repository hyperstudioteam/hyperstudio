...
use commands::{
    alter_column, alter_key, alter_table, connect, disconnect, er_diagram, execute_query,
    install_plugin, list_drivers, list_object_groups, list_object_subgroup, list_objects,
    list_plugins, list_schema, list_schemas, list_tables, reload_plugins, set_plugin_enabled,
