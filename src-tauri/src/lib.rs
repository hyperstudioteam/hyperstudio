...
use commands::{
    ...
    install_plugin, keychain_available, keychain_delete, keychain_get, keychain_set, list_databases,
    list_drivers, list_object_groups, list_object_subgroup, list_objects, list_plugins, list_schema,
